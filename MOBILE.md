...
> gained a week view and an offline queue of its own, and `deploy/install.sh` sets the server up
> in one command. This document is kept as the comparison that led there, and as the costed
