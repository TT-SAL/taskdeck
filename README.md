...
**Routines** are the third thing the **New** switch makes, and they are for the parts of a day that are simply spoken for: sleeping, cooking, the commute, the gym. Draw one the way you draw anything else and it comes back every week — the footer's day row is where you say which days, with **All** for the daily ones.
